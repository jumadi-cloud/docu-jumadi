    ...
    courses: [
      {
        ...
        description: <>Membahas pemrograman Go-Lang secara tuntas, dari Go-Lang Dasar, Modules, Database, sampai membuat RESTful API</>,
        link: '/kelas-online/golang',
      },
      {
        title: 'Kelas Java',
        image: require('../../static/img/kelas-online/small/java.jpg').default,
        description: <>Membahas pemrograman Java secara tuntas, dari Java Dasar, OOP, Database, Web, sampai membuat RESTful API</>,
        link: '/kelas-online/java',
      },
      {
        title: 'Kelas JavaScript',
        image: require('../../static/img/kelas-online/small/javascript.jpg').default,
        description: <>Membahas pemrograman JavaScript secara tuntas, dari JavaScript Dasar, OOP, Modules, DOM, sampai membuat Async</>,
        link: '/kelas-online/javascript',
      },
      {
        title: 'Kelas PHP',
        image: require('../../static/img/kelas-online/small/php.jpg').default,
        description: <>Membahas pemrograman PHP secara tuntas, dari PHP Dasar, OOP, Database, Web, Unit Test, Composer, MVC, sampai membuat RESTful API</>,
        link: '/kelas-online/php',
      },
      {
        title: 'Kelas Kotlin',
        image: require('../../static/img/kelas-online/small/kotlin.jpg').default,
        description: <>Membahas pemrograman Kotlin secara tuntas, dari Kotlin Dasar, OOP, Generic, Collection, sampai membuat Coroutine</>,
        link: '/kelas-online/kotlin',
      },
      {
        title: 'Kelas Dart',
        image: require('../../static/img/kelas-online/small/dart.jpg').default,
        description: <>Membahas pemrograman Dart secara tuntas, dari Dart Dasar, OOP, Packages, sampai membuat Async</>,
    ...
    courses: [
      {
        ...
        description: <>Membahas database MySQL secara tuntas, dari MySQL Dasar, sampai membuat Studi Kasus MySQL</>,
    ...
    courses: [
      {
        ...
        description: <>Membahas Spring Framework dan Spring Boot secara tuntas, dari dasar sampai mahir, disertau studi kasus.</>,
        link: '/kelas-online/spring-boot',
      },
      {
        title: 'Kelas NodeJS',
        image: require('../../static/img/kelas-online/small/nodejs.jpg').default,
        description: <>Membahas NodeJS secara tuntas, dari dasar sampai mahir, disertau studi kasus.</>,
    ...
    courses: [
      {
        ...
        description: <>Membahas Android secara tuntas, dari dasar sampai mahir, disertau studi kasus.</>,
    ...
    courses: [
      {
        ...
        description: <>Membahas Docker secara tuntas, dari dasar sampai mahir, disertau studi kasus.</>,
    ...
    courses: [
      {
        ...
        image: require('../../static/img/kelas-online/small/spring.jpg').default,
        description: <>Membahas Spring Design Patterns secara tuntas, dari Creational Patterns, Structural Patterns dan Behavioral Patterns</>,
    ...
    courses: [
      {
        ...
        description: <>Membahas Git secara tuntas, dari Git Dasar, Git Branching sampai Git Remote</>,
        link: '/kelas-online/git',
      },
      {
        title: 'Kelas HTTP',
        image: require('../../static/img/kelas-online/small/http.jpg').default,
        description: <>Membahas HTTP secara tuntas, dari Pengenalan HTTP, HTTP Request, HTTP Response sampai Header dan Caching</>,
        link: '/kelas-online/http',
      },
      {
        title: 'Kelas RESTful API',
        image: require('../../static/img/kelas-online/small/restfulapi.jpg').default,
        description: <>Membahas RESTful API secara tuntas, dari Pengenalan API, Resource Naming sampai HATEOAS</>,
        link: '/kelas-online/restful-api',
      },
      {
        title: 'Kelas OpenAPI',
        image: require('../../static/img/kelas-online/small/openapi.jpg').default,
        description: <>Membahas OpenAPI secara tuntas, dari Pengenanaln OpenAPI, Tipe Data, Schema Sampai Code Generator</>,
    ...
    <header className={clsx('hero hero--dark', styles.heroBanner)}>
      <div className="container">
        ...
        <p className="hero__subtitle">
          Yuk gabung dengan RIBUAN peserta yang sudah bergabung kelas Programmer Zaman Now. <br />
          Bayar sekali, akses kelasnya SELAMANYA. Dan GRATIS jika ada update materi baru!
        </p>
      </div>
    </header>
  );
...
export default function OnlineCoursesPage() {
  const { siteConfig } = useDocusaurusContext();
  return (
    <Layout title="Kelas Online" description="Buka Masa Depanmu Dengan Terus Belajar!<head />">
      <OnlineCoursesHeader />
      <OnlineCourses />
    </Layout>
  );
